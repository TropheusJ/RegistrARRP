...
import com.tterrag.registrarrp.fabric.FluidBlockHelper;
import com.tterrag.registrarrp.fabric.RegistryObject;
import com.tterrag.registrarrp.fabric.SimpleFlowableFluid;
import com.tterrag.registrarrp.fabric.SimpleFluidRenderHandler;
...
//                })
     ...
     */
    @SafeVarargs
    public final FluidBuilder<T, P> tag(Identified<Fluid>... tags) {
...
//        }
     ...
     */
    @SafeVarargs
    public final FluidBuilder<T, P> removeTag(Identified<Fluid>... tags) {
