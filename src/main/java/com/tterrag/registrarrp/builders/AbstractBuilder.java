...
//    }
    ...
    /**
     * Set the lang for this entry to the default value.
     *
     * @return this {@link Builder}
     */
    ...
    public S lang(String name) {
        return lang("en_us",
                Util.createTranslationKey(RegistryUtil.getRegistry(getRegistryType()).getKey().getValue().getPath(), new Identifier(getOwner().getModid(), getName())),
                name);
    }
