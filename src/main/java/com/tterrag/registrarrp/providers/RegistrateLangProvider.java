...
//    }
//    
//    public void addTooltip(NonNullSupplier<? extends ItemConvertible> item, String tooltip) {
//        add(item.get().asItem().getTranslationKey() + ".desc", tooltip);
//    }
//    
//    public void addTooltip(NonNullSupplier<? extends ItemConvertible> item, List<@NonnullType String> tooltip) {
...
//        add(((TranslatableText)group.getTranslationKey()).getKey(), name);
//    }
//    
