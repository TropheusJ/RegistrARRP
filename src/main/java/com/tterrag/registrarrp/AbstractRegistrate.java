...
//    }
    ...
    /**
     * Registers everything. This registrarrp should not be used after calling this method.
     */
...
//        addDataGenerator(ProviderType.LANG, prov -> ret.forEach(p -> prov.add(p.getKey(), p.getValue())));
    ...
    /**
     * Add a custom translation mapping, prepending this registrarrp's {@link #getModid() mod id} to the translation key.
     * 
     * @param key
     *            The translation key
     * @param value
